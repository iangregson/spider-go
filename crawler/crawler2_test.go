...
func Test2LocalConcurrency1(t *testing.T) {
...
func Test2LocalConcurrency2(t *testing.T) {
	server := httptest.NewServer(http.FileServer(http.Dir("../fixtures/html")))
	defer server.Close()
...
func Test2LocalConcurrency16(t *testing.T) {
	server := httptest.NewServer(http.FileServer(http.Dir("../fixtures/html")))
	defer server.Close()
...
func Test2RemoteConcurrency64(t *testing.T) {
	c := crawler.New(64)
